...
Pengembangan antarmuka pengguna (\textit{user interface}/UI) yang responsif,
intuitif, dan terintegrasi dengan sistem \textit{back-end} merupakan komponen
penting dalam aplikasi kesehatan digital skala enterprise. Kualitas antarmuka
pengguna secara langsung memengaruhi efisiensi operasional tenaga medis dalam
mengakses dan mengelola informasi kesehatan pasien. Pengalaman pengembangan
aplikasi berbasis Flutter selama masa studi diimplementasikan pada produk
digital nyata yang digunakan secara luas di industri.
...
\textit{maintainability} kode dalam jangka panjang. Transisi ini juga
memberikan kesempatan studi kasus nyata terhadap keputusan pemilihan
\textit{tech stack} pada aplikasi skala enterprise.
